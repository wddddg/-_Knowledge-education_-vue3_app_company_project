<template>
		<!-- <u-navbar :z-index="'999999'" title-width="150" title="书籍详情" ></u-navbar> -->
	<view style="height: 100%;">
		...
		<view class="menu" :style="{height: `100%`, width: `${windowWidth}px`}" v-if="menuShow" @touchend="closeMenu">
			...
			<view class="menu-bottom" :style="{bottom: itemShow ? 0 : '-100%'}" @touchend.stop>
				...
				<view class="mysetting">
					<view class="item">
						...
						<view class="icon" @click="changeFont(1)" v-else
							style="border: #FF9900 solid 1px;color: #FF9900">繁體</view>
					</view>
					<view class="item">
					...
					<view class="item">
						...
						<view class="icon" style="background-color: #fff;" :class="{active: background === 0}"
							@click="changeBackground(0)"></view>
						<view class="icon" style="background: url(/static/read/skin-default-m.jpg);"
							:class="{active: background === 1}" @click="changeBackground(1)"></view>
						<view class="icon" style="background-color: #202020;" :class="{active: background === 2}"
				...
				<view class="items-box">
					...
					<view class="item-box" v-if="background === 2" @click="changeBackground(0)">
						<text class="iconfont" style="font-size: 25px;">&#xe64c;</text>
						<text style="font-size: 13px;">日间</text>
					</view>
					<view class="item-box" @click="shareclick(2)">
						<text class="iconfont" style="font-size: 25px;">&#xe62c;</text>
						<text style="font-size: 13px;">分享</text>
					</view>
					<view class="item-box" @click="openSetting()">
						<text class="iconfont" style="font-size: 25px;">&#xe61d;</text>
						<text style="font-size: 13px;">字体</text>
					</view>
				</view>
			</view>
			...
			<!-- 设置点进去 -->
			<view class="font-setting" :style="{bottom: settingShow ? 0 : `-100%`}" v-if="settingShow" @touchend.stop>
				<view class="item">
					<view class="icon" v-for="(item,index) in fonts" :key='index'
						:class="{active: fontType === item.id}" style="padding: 5px 8px;"
						@click="changeFontType(item.id,item.path)">{{item.name}}</view>

					<!-- 	<view class="icon" :class="{active: fontType === 2}" style="padding: 5px 8px;"
						@click="changeFontType(2)">字体3</view> -->
				</view>
			</view>

			<!-- 目录层 -->
			<view class="directory" v-if="directoryShowBefore" @touchend.stop>
				...
				<view style="margin: 10rpx 10rpx;" v-for="(item,index) in dataMU" :key="index"
		...
		<u-modal v-model="vipshow" :mask-close-able="true" confirm-text="购买会员" @confirm="vipConfirm"
			content="会员免费，请先开通书籍会员!"></u-modal>

		<u-modal v-model="vipshowPay" :show-cancel-button="true" :mask-close-able="true" :cancel-text="cancelText"
			confirm-text="购买会员" @confirm="vipConfirm" @cancel="CanclePay" content="付费下载,开通宝库会员更优惠哦!"></u-modal>
	...
	export default {
		...
		data() {
			return {
				...
				fontType: 0,
				text: `<p>你好你这些的了我卡可能不动笔</p><p>你是本地测试，测试测试，测试测试测试测试测试，测试测试测试测试测试，测试测试测试测试测试，测试测试测。</p><p>测试测试测试测试测试，测试测试，测试测试，测试测试测试测试测试，测试测试测试测试测试</p><p>测试测试测试测试测试，测试测试，测试测试，测试测试测试测试测试，测试测试测试测试测试，测试测试测。</p><p>测试测试测试测试测试，测试测试，测试测试，测试测试测试测试测试，测试测试测试测试测试，测试测试测试测试测试，测试测试测。</p><p>测试测试测试测试测试，测试测试，测试测试，测试测试测试测试测试，测试测试测试测试测试</p><p>测试测试测试测试测试，测试测试，测试测试，测试测试测试测试测试，测试测试测试测试测试，测试测试测。</p><p>测试测试测试测试测试，测试测试，测试测试，测试测试测试测试测试，测试测试测试测试测试，测试测试测试测试测试，测试测试测。</p><p>测试测试测试测试测试，测试测试，测试测试，测试测试测试测试测试，测试测试测试测试测试</p><p>测试测试测试测试测试，测试测试，测试测试，测试测试测试测试测试，测试测试测试测试测试，测试测试测。</p><p>测试测试测试测试测试，测试测试，测试测试，测试测试测试测试测试，测试测试测试测试测试，测试测试测试测试测试，测试测试测。</p><p>测试测试测试测试测试，测试测试，测试测试，测试测试测试测试测试，测试测试测试测试测试</p><p>测试测试测试测试测试，测试测试，测试测试，测试测试测试测试测试，测试测试测试测试测试，测试测试测。</p><p>测试测试测试测试测试，测试测试，测试测试，测试测试测试测试测试，测试测试测试测试测试，测试测试测试测试测试，测试测试测。</p><p>测试测试测试测试测试，测试测试，测试测试，测试测试测试测试测试，测试测试测试测试测试</p><p>测试测试测试测试测试，测试测试，测试测试，测试测试测试测试测试，测试测试测试测试测试，测试测试测。</p><p>测试测试测试测试测试，测试测试，测试测试，测试测试测试测试测试，测试测试测试测试测试，测试测试测试测试测试，测试测试测。</p><p>测试测试测试测试测试，测试测试，测试测试，测试测试测试测试测试，测试测试测试测试测试</p><p>测试测试测试测试测试，测试测试，测试测试，测试测试测试测试测试，测试测试测试测试测试，测试测试测。</p><p>测试测试测试测试测试，测试测试，测试测试，测试测试测试测试测试，测试测试测试测试测试，测试测试测试测试测试，测试测试测。</p><p>测试测试测试测试测试，测试测试，测试测试，测试测试测试测试测试，测试测试测试测试测试</p><p>测试测试测试测试测试，测试测试，测试测试，测试测试测试测试测试，测试测试测试测试测试，测试测试测。</p><p>测试测试测试测试测试，测试测试，测试测试，测试测试测试测试测试，测试测试测试测试测试，测试测试测试测试测试，测试测试测。</p><p>测试测试测试测试测试，测试测试，测试测试，测试测试测试测试测试，测试测试测试测试测试</p><p>测试测试测试测试测试，测试测试，测试测试，测试测试测试测试测试，测试测试测试测试测试，测试测试测。</p><p>测试测试测试测试测试，测试测试，测试测试，测试测试测试测试测试，测试测试测试测试测试，测试测试测试测试测试，测试测试测。</p><p>测试测试测试测试测试，测试测试，测试测试，测试测试测试测试测试，测试测试测试测试测试</p><p>测试测试测试测试测试，测试测试，测试测试，测试测试测试测试测试，测试测试测试测试测试，测试测试测。</p><p>测试测试测试测试测试，测试测试，测试测试，测试测试测试测试测试，测试测试测试测试测试，测试测试测试测试测试，测试测试测。</p><p>测试测试测试测试测试，测试测试，测试测试，测试测试测试测试测试，测试测试测试测试测试</p><p>测试测试测试测试测试，测试测试，测试测试，测试测试测试测试测试，测试测试测试测试测试，测试测试测。</p><p>测试测试测试测试测试，测试测试，测试测试，测试测试测试测试测试，测试测试测试测试测试，测试测试测试测试测试，测试测试测。</p><p>测试测试测试测试测试，测试测试，测试测试，测试测试测试测试测试，测试测试测试测试测试</p><p>测试测试测试测试测试，测试测试，测试测试，测试测试测试测试测试，测试测试测试测试测试，测试测试测。</p><p>测试测试测试测试测试，测试测试，测试测试，测试测试测试测试测试，测试测试测试测试测试，测试测试测试测试测试，测试测试测。</p><p>测试测试测试测试测试，测试测试，测试测试，测试测试测试测试测试，测试测试测试测试测试</p><p>测试测试测试测试测试，测试测试，测试测试，测试测试测试测试测试，测试测试测试测试测试，测试测试测。</p><p>测试测试测试测试测试，测试测试，测试测试，测试测试测试测试测试，测试测试测试测试测试，测试测试测试测试测试，测试测试测。</p><p>测试测试测试测试测试，测试测试，测试测试，测试测试测试测试测试，测试测试测试测试测试</p><p>测试测试测试测试测试，测试测试，测试测试，测试测试测试测试测试，测试测试测试测试测试，测试测试测。</p><p>测试测试测试测试测试，测试测试，测试测试，测试测试测试测试测试，测试测试测试测试测试，测试测试测试测试测试，测试测试测。</p><p>测试测试测试测试测试，测试测试，测试测试，测试测试测试测试测试，测试测试测试测试测试</p><p>测试测试测试测试测试，测试测试，测试测试，测试测试测试测试测试，测试测试测试测试测试，测试测试测。</p><p>测试测试测试测试测试，测试测试，测试测试，测试测试测试测试测试，测试测试测试测试测试，测试测试测试测试测试，测试测试测。</p><p>测试测试测试测试测试，测试测试，测试测试，测试测试测试测试测试，测试测试测试测试测试</p><p>测试测试测试测试测试，测试测试，测试测试，测试测试测试测试测试，测试测试测试测试测试，测试测试测。</p><p>测试测试测试测试测试，测试测试，测试测试，测试测试测试测试测试，测试测试测试测试测试，测试测试测试测试测试，测试测试测。</p><p>测试测试测试测试测试，测试测试，测试测试，测试测试测试测试测试，测试测试测试测试测试</p>`,
				directoryList: [], //目录列表
				currentPage: 0, //当前页
				...
				options: {},
				staticUrl: getApp().globalData.webApi,
				chapterId:'',
				pageIndax:'',
			}
		},
		onShareAppMessage() {
			return {
				title: '我发现了一家宝藏电子文库，快来看看吧！', // 分享名称
				path: 'pages/home/home/Home', // 这里写你这个页面的路径
				imageUrl: '../../../../static/aaa.jpg',
		...
		onLoad(options) {
			...
			this.pageIndax = options.pageIndax
			// 获取设备信息
			this.getSystemInfo()
		},
		onUnload() {
		...
		methods: {
			...
			fontFace(path) {
				uni.loadFontFace({
					family: 'Bitstream',
					source: `url(${this.staticUrl+path})`,
					success(res) {
			...
			async initPage() {
				...
				debugger
				if(this.pageIndax){
					await this.getThreeChapter(parseInt(this.pageIndax))
				}else{
			...
			calcHeight() {
				if (this.contentHeight) {
					...
					// #endif
					let lineNum = Math.floor((this.contentHeight + Math.floor((lineHeight - this
							.fontSize) / 2)) /
						lineHeight)
					...
					return new Promise((resolve, reject) => {
						this.$nextTick(() => {
							...
							query.select('#content').boundingClientRect(data => {
								...
								// #ifdef APP-PLUS || MP-WEIXIN
								lineHeight = Math.floor(lineHeight * this
										.pixelRatio) / this
									.pixelRatio
								// #endif
			...
			coverTouchEnd(e) {
				...
				if (delta === 0) {
					...
					} else if (e.changedTouches[0].clientX <= this.windowWidth / 3 * 2 && e.changedTouches[
							0].clientX >=
						this.windowWidth /
						3) { //点击屏幕中间1/3为呼出菜单
						this.showMenu()
			...
			async chapterRotate(type) {
				if (type === 'next') {
					...
					if (this.curChapter.chapterIndex !== this.directoryList.length -
						1) { //最后一章是根据目录列表长度判断
						this.nextChapter = {
							ready: false,
							chapterIndex: this.curChapter.chapterIndex + 1,
							chapterName: this.directoryList[this.curChapter.chapterIndex + 1]
								.name,
						}
						await this.getOneChapter(this.directoryList[this.curChapter.chapterIndex +
							1].chapterId)
			...
			async changeLineHeight(lineHeight) {
				...
				if (lineHeight === this.lineHeight) {
					...
					this.calcHeight()
					await this.calcCurChapter()
					let page = Math.floor((this.curChapter.totalPage - 1) *
						progress)
					this.goToPage(page)
					if (this.preChapter.ready && !this.preChapter.isCover) {
						this.preChapter.ready = false
			 ...
			 * 改变字体
			 **/
			changeFontType(fontType, path) {
				if (fontType === this.fontType) {
					return
				} else {
					...
					// uni.setStorageSync('fontType', this.fontType)
				}
			},
			...
			getDirectoryList(showLoading) {
				...
				// 书籍id 获取列表数据 把然后把值像下面那样map 注意字段名  然后去看那个获取三章数据的方法 getThreeChapter
				return new Promise((resolve, reject) => {
					// chapterCate({
					...
					// 			index: index,
					// 			isFree: item.is_free,
					// 			name: `第${index+1}章 ${item.name}`,

					// 		}
					// 	})
					// 	this.directoryList = data
					// 	this.dataMU = data
					// 	// console.log(this.directoryList[0].name,'列表列表-------');
					// 	resolve()
					// })
					
					findSectionList({bookId:this.bookId}).then(res=>{
						let data = [] 
						res.result.forEach((itme,index)=>{
							if(itme.childBookSectionList){
								itme.childBookSectionList.forEach((j,i)=>{
									let param = {
										chapterId: j.id,
										articleId: j.bookId,
										index: index,
										isFree: true,
										name: `第${index+1}章 第${i+1}节 ${j.name}`,
									}
									data.push(param)
								})
							}
			...
			getOneChapter(chapterId, showLoading) {
				...
				return new Promise((resolve, reject) => {
					var data;
					for (var i = 0; i < that.directoryList.length; i++) {
						if (that.directoryList[i].chapterId == chapterId) {
							data = that.directoryList[i]
						}
					}
					// canRead true 免费  false 收费
					// isFree  1 免费 0 收费
					if (data.isFree == 1) {
						that.tmpChapter.canRead = true
					} else {
						// 先是要付费的 后面再判断改变类型
						that.tmpChapter.canRead = false
						// // 需要付费才显示
						// if (that.detail.is_super_vip == 1 || that.detail
						// 	.is_pay == 1) {
						// 	// 超级会员直接看 或购买过直接看 
						// 	that.tmpChapter.canRead = true
						// } else {
						// 	if (that.detail.need_pay == 0) {
						// 		//免费看
						// 		that.tmpChapter.canRead = true
						// 	} else if (that.detail.need_pay == 1) {
						// 		// 会员免费看 需要开会员
						// 		this.vipshow = true
						// 	} else {
						// 		// 付费看 普通和会员两种价格
						// 		that.vipshowPay = true
						// 		if (that.detail.is_member == 1) {
						// 			that.cancelText = '单次支付' + that.detail
						// 				.member_money + '购买'
						// 		} else {
						// 			that.cancelText = '单次支付' + that.detail
						// 				.common_money + '购买'
					...
					console.log(that.tmpChapter.canRead, '是否免费');
					...
					if (data) {
						...
						// }).then(res => {
						// 	that.tmpChapter.text =
						// 		`<p>${chapterId}</p>` + res.data
						// 		.content //模拟数据
						// 	// console.log(this.tmpChapter.text,'text--');
						// 	// 根据业务实际情况判断该用户是否可阅读,逻辑后端判断
						// 	// this.tmpChapter.canRead = true
						// 	resolve()
						// })
						getSectionById({bookId:data.articleId,id:data.chapterId}).then(res=>{
								that.tmpChapter.text = res.result.content
								//模拟数据
								// console.log(this.tmpChapter.text,'text--');
								// 根据业务实际情况判断该用户是否可阅读,逻辑后端判断
								// this.tmpChapter.canRead = true
						...
						that.tmpChapter.text = '' //注意：不能阅读章节请赋值为空字符串

						根据业务实际情况判断该用户是否可阅读, 逻辑后端判断
						that.tmpChapter.canRead = false
					}

					if (that.simplified === 2) { //切换为繁体  注意：这里默认数据库中是简体字
						that.tmpChapter.text = traditionalized(that
							.tmpChapter.text)
					}
					// console.log(that.tmpChapter,'tmpChapter');
					// console.log(that.tmpChapter.canRead,'tmpChapter');
					// console.log(that.tmpChapter.text,'text');
					// }, 300)
				}).then(() => {}, () => {
			...
			/**
			 * 获取三章数据  这里判断你是获取第几章 获取到你的上一章和下一章做准备  然后就是获取一章数据的方法 getOneChapter 通过上面
			 * 列表章节id  获取章节内容 
			 **/
			async getThreeChapter(index) {
				var that = this
				console.log(index, '获取三章数据666');
				debugger
				if(that.directoryList.length == 0){
					uni.showToast({
						title:'暂无内容',
						icon:'none'
					})
				...
				await that.getOneChapter(that.directoryList[index].chapterId)

				// console.log(that.tmpChapter,'获取');
				// console.log(that.tmpChapter.np,'np');
				console.log(that.tmpChapter, '数据数据数据');

				that.curChapter = {
					chapterIndex: index,
					chapterName: that.directoryList[index].name,
					text: that.tmpChapter.text,
					canRead: that.tmpChapter.canRead
				}



				if (that.curChapter.chapterIndex != 0) {
					await that.getOneChapter(that.directoryList[index - 1]
						.chapterId)
					that.preChapter = {
						chapterIndex: index - 1,
						chapterName: that.directoryList[index - 1].name,
						text: that.tmpChapter.text,
						canRead: that.tmpChapter.canRead
					}
				} else {
				...
				if (that.curChapter.chapterIndex !== that.directoryList
					.length - 1) {
					await that.getOneChapter(that.directoryList[index + 1]
						.chapterId)
					that.nextChapter = {
				...
				await that.calcCurChapter()
				await that.calcPreChapter()
				await that.calcNextChapter()
			},
			...
			buyBook() {
				uni.navigateTo({
					url: '/pages/detail/vip/customVip/CustomVip'
				})
			},
...
<style lang="scss" scoped>
	...
	// @font-face {
	// 	font-family: 'ForteMT';
	// 	src: url('https://test.read.leapy.cn/upload/20210823/44bee0f6bc8a55277eb469e77a166f3f.ttf');
	// }
	...
	.container0 {
		// background: url(/static/read/skin-default-m.jpg);
		background-color: #fff;
	...
	.menu {
		...
		.directory {
			...
			.directory-listItem {
				...
				height: 40px;
				font-size: 30rpx;
				border-bottom: #FEF0F0 solid 1px;
			}
