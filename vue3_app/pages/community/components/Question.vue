<template>
  <view>
    <view class="navbar11" v-if="showNav">
      <uni-segmented-control v-if="items" :current="current" :values="items" :style-type="'text'" :active-color="activeColor"
    ...
    <scroll-view :style="'height: 75vh'" @refresherrefresh="refresherrefresh"
          ...
          <view class="list-item" v-for="(item,index) in communityList" :key="index">
            <view class="list-top">
              <view class="ima">
                ...
                <view>
                  <view class="aut">
                    {{item.authorName}}<view class="zhiding" v-if="item.oneCateName">{{item.oneCateName}}</view>
                  </view>
                  <view class="date">
                    {{item.createTime}}
                  </view>
            ...
            <template v-if="applyStatus!=2">
              <view class="pingl" v-if="item.commentVOList&&item.commentVOList.length>0">
                <view class="p-list">
                  <view class="list-top" v-for="it in item.commentVOList" :key="it.id" @click="handleTo(it)">
                    <view class="ima">
                      <image src="@/static/user/user-avatar.png" v-if="!it.headImg" />
                      <image :src="it.headImg" v-else />
                      <view>
                        <view class="aut">
                          {{it.createBy}}
                        </view>
                ...
                <view class="more" @click="commonHandleTo(item)">
                  共{{item.commentCount}}条解答>>
                </view>
              </view>
            </template>
...
import { myPushNewsListForPage, myCollectionNewsListForPage, apiNewsListForPage, addNewsGood, addNewsCollection, systemCategory } from '../community.api'
