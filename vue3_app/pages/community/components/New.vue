<template>
  <view>
    ...
    <view style="padding-top:100rpx">
      <Banner :bannerList="bannerList" :isClass="true" v-if="bannerList && bannerList.length > 0" />
    </view>
    <scroll-view :style="'height:54vh'" @refresherrefresh="refresherrefresh" @scrolltolower="onReachBottoms"
      class="scroll-Y" :refresher-triggered="triggered" :scroll-y="true" :refresher-threshold="45"
      :scroll-anchoring="true" :refresher-enabled="refresher ? false : true">
...
import { findBannerList, addTeacherCollection, myPushNewsListForPage, myCollectionNewsListForPage, apiNewsListForPage, addNewsGood, addNewsCollection, systemCategory } from '../community.api'
...
const indexCustom = uni.getStorageSync('indexCustom')
const indexItme = ref(indexCustom?.websiteHtmlCustomModuleVOList)
