<template>
  <scroll-view :style="'height: 78vh'" @refresherrefresh="refresherrefresh"
...
import { myPushNewsListForPage, myCollectionNewsListForPage, apiNewsListForPage, addNewsGood } from '../community.api'
