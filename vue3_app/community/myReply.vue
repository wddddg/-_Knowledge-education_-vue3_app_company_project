...
<template>
    <view class="container" :style="{'--theme-color':themeColor}">
        <u-navbar :is-back="true" title="我的回复"></u-navbar>
                        ...
                        <view class="list-item" v-for="(item,index) in communityList" :key="index">
                            ...
                            <view class="pingl">
                                ...
                                <view class="list-cot-image" v-if="item.newImgVOList&&item.newImgVOList.length>0"
                                    ...
                                    <image v-for="(it,i) in item.newImgVOList" :key="i" :src="it" mode="aspectFill" />
                                </view>
                            </view>
                            <view class="list-bom">
...
import { myReplyNewsCommentListForPage } from '@/community/community.api'
...
const getCommunityList = async () => {
    ...
    const res = await myReplyNewsCommentListForPage({ ...params.value, pageNo: page.value });
