          ...
          <view class="list-item" v-for="(item,index) in communityList" :key="index">
            <view class="list-top">
              <view class="ima">
                ...
                <view>
                  <view class="aut">
                    {{item.authorName}}<view class="zhiding">{{item.oneCateName}}</view>
                  </view>
                  <view class="date">
                    {{item.createTime}}
                  </view>
...
import { myPushNewsListForPage, myCollectionNewsListForPage, apiNewsListForPage, addNewsGood, addNewsCollection, systemCategory } from '@/community/community.api'
